...
export default function FAQ() {
  ...
  const subtitle = locale === "ar" ? "لديك سؤال؟" : "Got a question?";
        ...
        >
          <div>
            ...
            <div style={{ fontSize:"13px", color:"rgba(255,255,255,0.38)" }}>
              {isRTL ? "فريقنا متاح للرد على أي سؤال عبر واتساب" : "Our team is available to answer any question via WhatsApp"}
            </div>
          </div>
          <a
          ...
          >
            ...
            >
              <span>{isRTL ? "اسألنا الآن" : "Ask Us Now"}</span>
            </button>
          </a>
        </div>
      </div>
