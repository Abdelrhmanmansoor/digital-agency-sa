    ...
    platforms: [
      {
        ...
        points: [
          ...
          "ربط مدى وأبل باي وتابي وتمارا وبوابات الدفع الرسمية",
          "إعداد الشحن ومناطق التوصيل وسياسات الإرجاع",
      ...
      },
      {
        ...
        points: [
          ...
          "ضبط الخيارات والمتغيّرات والمخزون متعدد الفروع",
          "ربط بوابات الدفع وشركات الشحن المعتمدة",
      ...
      },
      {
        ...
        points: [
          ...
          "تهيئة الـ Checkout وربط بوابات الدفع الدولية والمحلية",
    ...
    platforms: [
      {
        ...
        points: [
          ...
          "Mada, Apple Pay, Tabby, Tamara and the official payment gateways",
          "Shipping, delivery zones and return policy configured",
      ...
      },
      {
        ...
        points: [
          ...
          "Options, variants and multi-branch inventory configured",
          "Payment gateways and approved shipping carriers connected",
      ...
      },
      {
        ...
        points: [
          ...
          "Checkout configured and international plus local gateways wired in",
    ...
    platforms: [
      {
        ...
        points: [
          ...
          "Mada, Apple Pay, Tabby, Tamara et les passerelles officielles",
          "Livraison, zones de distribution et politique de retour configurées",
      ...
      },
      {
        ...
        points: [
          ...
          "Options, variantes et stock multi-succursales configurés",
          "Passerelles de paiement et transporteurs agréés connectés",
      ...
      },
      {
        ...
        points: [
          ...
          "Checkout configuré, passerelles internationales et locales",
