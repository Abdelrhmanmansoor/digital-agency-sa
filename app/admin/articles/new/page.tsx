    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <main className="admin-main" style={{ padding: "40px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "32px" }}>
          <h1 style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "24px", fontWeight: 700, color: "#0A0A0A" }}>
            مقال جديد
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={15}
                    className="form-input"
                    style={{ ...inputStyle, resize: "vertical", fontFamily: "'ThmanyahSans', 'Zain', sans-serif" }}
                  />
                </div>
                <div>
          ...
          <div className="space-y-6">
            ...
            <div style={{ background: "#FFFFFF", border: "1px solid #E8E6E1", padding: "24px" }}>
              <h3 style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "16px", fontWeight: 700, color: "#0A0A0A", marginBottom: "20px" }}>
                إعدادات المقال
              </h3>
