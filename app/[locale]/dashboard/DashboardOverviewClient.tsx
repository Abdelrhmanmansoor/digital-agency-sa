...
export default function DashboardOverviewClient({ userName, stats, recentOrders, locale }: Props) {
  ...
  const statCards = [
    { num: stats.total,      labelAr: "إجمالي الطلبات",    labelEn: "Total Orders",    icon: "📋", color: "#F0B100" },
    ...
    { num: stats.files,      labelAr: "ملفات مستلمة",       labelEn: "Files Received",  icon: "📁", color: "#F0B100" },
  ];
  ...
  return (
    <div style={{ padding: "40px", direction: isRTL ? "rtl" : "ltr", maxWidth: "1100px" }}>
      ...
      <div style={{ marginBottom: "40px" }}>
        ...
        <h1 style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "clamp(24px, 4vw, 36px)", fontWeight: 800, color: "#FAFAF7", margin: 0 }}>
          {isRTL ? `مرحباً، ${userName}` : `Hello, ${userName}`}
        </h1>
        <p style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.4)", marginTop: "8px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px", marginBottom: "40px" }}>
        {statCards.map((s) => (
          ...
          >
            ...
            <div style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "13px", color: "rgba(255,255,255,0.4)", marginTop: "6px" }}>
      ...
      <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "16px", padding: "28px 28px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px" }}>
          <h2 style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "18px", fontWeight: 700, color: "#FAFAF7", margin: 0 }}>
        ...
        {recentOrders.length === 0 ? (
          <div style={{ textAlign: "center", padding: "40px 0" }}>
            ...
            <div style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.3)" }}>
          ...
          <div>
            {recentOrders.map((o) => {
              ...
              return (
                ...
                >
                  <div>
                    <div style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "15px", fontWeight: 700, color: "#FAFAF7", marginBottom: "3px" }}>{o.title}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginTop: "24px" }}>
        ...
        >
          <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: "rgba(240,177,0,0.12)", display: "flex", alignItems: "center", justifyContent: "center", color: "#F0B100", flexShrink: 0 }}>
          ...
          <div>
            <div style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "15px", fontWeight: 700, color: "#F0B100" }}>{isRTL ? "طلب خدمة جديدة" : "New Service Order"}</div>
            <div style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "12px", color: "rgba(255,255,255,0.35)", marginTop: "2px" }}>{isRTL ? "8 خدمات متاحة" : "8 services available"}</div>
          </div>
        </a>
        <a
          href={`${basePath}/files`}
        ...
        >
          <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: "rgba(240,177,0,0.08)", display: "flex", alignItems: "center", justifyContent: "center", color: "#F0B100", flexShrink: 0 }}>
          ...
          <div>
            <div style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "15px", fontWeight: 700, color: "#F0B100" }}>{isRTL ? "ملفاتي المستلمة" : "My Delivered Files"}</div>
