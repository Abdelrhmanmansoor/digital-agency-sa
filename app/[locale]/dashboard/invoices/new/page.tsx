      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: "28px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
            <span style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "16px", fontWeight: 700, color: "#F0B100" }}>
            ...
            <button
              ...
              style={{
                padding: "6px 14px", background: "rgba(240,177,0,0.1)",
                border: "1px solid rgba(240,177,0,0.2)", borderRadius: "7px",
                color: "#F0B100", fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "13px", cursor: "pointer",
              }}
            >
              ...
              <div key={item.id} style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr auto auto auto", gap: "10px", alignItems: "end" }}>
                  ...
                  <div style={{ minWidth: "90px" }}>
                    ...
                    <div style={{
                      padding: "10px 12px", background: "rgba(240,177,0,0.06)",
                      border: "1px solid rgba(240,177,0,0.15)", borderRadius: "8px",
                      fontFamily: "Space Mono, monospace", fontSize: "13px",
                      color: "#F0B100", textAlign: "center", whiteSpace: "nowrap",
                    }}>
          ...
          <div style={{
            ...
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "8px", marginTop: "2px", display: "flex", gap: "32px" }}>
              <span style={{ fontFamily: "'ThmanyahSans', 'Zain', sans-serif", fontSize: "15px", fontWeight: 700, color: "#FAFAF7" }}>
                {isRTL ? "الإجمالي" : "Total"}
              </span>
              <span style={{ fontFamily: "Space Mono, monospace", fontSize: "16px", fontWeight: 700, color: "#F0B100", minWidth: "80px", textAlign: "end" }}>
