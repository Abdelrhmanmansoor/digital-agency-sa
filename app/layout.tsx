...
export const metadata: Metadata = {
  title: "تصميم متجر سلة وزد احترافي في السعودية 2026 | وكالة تسويق رقمي",
  description:
    "متخصصون في تصميم متجر سلة وزد احترافي، تخصيص ثيم سلة، ربط بوابات الدفع تابي وتمارا وSTC Pay، SEO للمتاجر، تصميم موقع مكتب محاماة، تسويق رقمي في الرياض والسعودية. تواصل واتساب.",
  keywords: [
...
const WEBSITE_SCHEMA = {
  ...
  potentialAction: {
    ...
    target: {
      "@type": "EntryPoint",
      urlTemplate: "https://www.solimanx.com/ar?q={search_term_string}",
    },
